...
import { useJamendoPlayer } from "@/hooks/useJamendoPlayer";
import {
  Play,
  Pause,
  SkipBack,
        ...
        <div className="container mx-auto h-full flex items-center justify-between gap-4 px-4">
          ...
          <div className="flex flex-col items-center gap-2 flex-1 max-w-2xl">
            ...
            <div className="flex items-center gap-3 w-full">
              ...
              <div 
                className="flex-1 h-1 bg-muted rounded-full overflow-hidden group cursor-pointer"
          ...
          <div className="flex items-center gap-4 w-48 shrink-0 justify-end">
            ...
            <div className="flex items-center gap-2">
              ...
              <div 
                className="w-20 h-1 bg-muted rounded-full overflow-hidden cursor-pointer"
